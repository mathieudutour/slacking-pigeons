...
type NEW_THREAD_HANDLER_TYPE = (thread: { teamId: string, text: string, id: string, socketId: string, threadId: string }) => void
type NEW_MESSAGE_HANDLER_TYPE = (message: { teamId: string, user: User, text: string, threadId: string, id: string }) => void
type REMOVE_THREAD_HANDLER_TYPE = (teamId: string, threadId: string) => void
type RECEIVED_MESSAGE_HANDLER_TYPE = (message: { teamId: string, text: string, id: string, threadId: string }) => void
