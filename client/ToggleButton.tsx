    ...
    return (
      <div
        style={{
          ...
          boxShadow:
            '0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)',
          cursor: 'pointer',
          background: '#3ead3f',
        }}
      ...
      >
        ...
        <div
          style={{
            transform: `rotate(${this.props.open ? 30 : 0}deg) scale(${this
              .props.open
              ? 0
              : 1})`,
            transition: 'transform .16s linear, opacity .08s linear',
